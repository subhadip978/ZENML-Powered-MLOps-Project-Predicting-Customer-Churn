...
def run_deployment(config:str, min_accuracy:float):
    ...
    if deploy:
        continuous_deployment_pipeline(
            data_path='/home/subhadip/brockdev/delhivery_time/data/olist_customers_dataset.csv',
    ...
    if existing_services:
        ...
        if service.is_running:
            print(
                ...
                f"process service and ready to accepts inference requests at:\n"
                f"    {service.prediction_url}\n"
                f"To stop the service, run the following command"
